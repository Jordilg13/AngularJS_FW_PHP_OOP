		...
		<ul id="flexiselDemo1">
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g1.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g2.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g3.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g8.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g5.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g6.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g7.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
			<li>
				<div class="flicker_grid-agile">
					<img src="frontend/assets/images/g4.jpg" alt=" " class="img-fluid" />
				</div>
			</li>
		</ul>
	</div>
